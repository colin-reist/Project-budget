...
class BudgetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_active', 'spent_amount', 'remaining_amount', 'percentage_used',
...
class BudgetListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'period_display', 'start_date', 'end_date', 'is_active',
            'spent_amount', 'percentage_used', 'is_over_budget', 'created_at'
        ]
