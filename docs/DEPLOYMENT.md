# 🚀 Guide de Déploiement - Budget Tracker

Ce guide explique comment déployer et gérer l'application Budget Tracker avec Docker et Docker Compose.

> **Note:** Pour un déploiement spécifique sur Raspberry Pi avec Caddy et DNS Infomaniak, consultez [RASPBERRY_PI.md](./RASPBERRY_PI.md)
